...
if __name__ == "__main__":
    ...
    # Experiment
    p.add_argument("--name", "-n", type=str, default="msdnet-kd-0.1main+conwaux-after90-60k", help="Experiment name")
    ...
    p.add_argument("--max_iter","-e", type=int, default=60000, help="Number of iterations")
