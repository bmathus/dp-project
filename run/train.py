...
if __name__ == "__main__":
    ...
    # Experiment
    p.add_argument("--name", "-n", type=str, default="msdnet-con-main-con-aux-40k", help="Experiment name")
    ...
    p.add_argument("--max_iter","-e", type=int, default=40000, help="Number of iterations")
