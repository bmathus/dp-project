...
if __name__ == "__main__":
    ...
    # Experiment
    p.add_argument("--name", "-n", type=str, default="msdnet-kd-0.1main+0.1en+conwaux", help="Experiment name")
    ...
    p.add_argument("--max_iter","-e", type=int, default=1000, help="Number of iterations")
