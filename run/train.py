...
if __name__ == "__main__":
    ...
    # Experiment
    p.add_argument("--name", "-n", type=str, default="loss-seg-config-3", help="Experiment name")
    ...
    p.add_argument('--lamda', type=float, default=0.25, help='weight to balance seg loss')
